...
module.exports = React.createClass({
  ...
  render: function() {
    ...
    for (var i = 0; i < this.props.videos.length; i++){
      thumbs.unshift(<Thumb key={i} index={i} videoDidStart={this.props.videoDidStart} isActive={i==this.props.activeVideo} video={this.props.videos[i]} makeActive={this.props.changeVideo} />);
    }
    return (
