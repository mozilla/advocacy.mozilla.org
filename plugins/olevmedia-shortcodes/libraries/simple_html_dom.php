...
define('HDOM_DEFAULT_TARGET_CHARSET', 'UTF-8');
define('HDOM_DEFAULT_BR_TEXT', "\r\n");
define('HDOM_DEFAULT_SPAN_TEXT', " ");
define('HDOM_MAX_FILE_SIZE', 600000);
// helper functions
// -----------------------------------------------------------------------------
// get html dom from file
// $maxlen is defined in the code as PHP_STREAM_COPY_ALL which is defined as -1.
function file_get_html($url, $use_include_path = false, $context=null, $offset = -1, $maxLen=-1, $lowercase = true, $forceTagsClosed=true, $target_charset = HDOM_DEFAULT_TARGET_CHARSET, $stripRN=true, $defaultBRText=HDOM_DEFAULT_BR_TEXT, $defaultSpanText=HDOM_DEFAULT_SPAN_TEXT)
{
...
function str_get_html($str, $lowercase=true, $forceTagsClosed=true, $target_charset = HDOM_DEFAULT_TARGET_CHARSET, $stripRN=true, $defaultBRText=HDOM_DEFAULT_BR_TEXT, $defaultSpanText=HDOM_DEFAULT_SPAN_TEXT)
{
    $dom = new simple_html_dom(null, $lowercase, $forceTagsClosed, $target_charset, $stripRN, $defaultBRText, $defaultSpanText);
...
class simple_html_dom_node
{
    ...
    function text()
    {
        ...
        if (!is_null($this->nodes))
        {
            ...
            if ($this->tag == "span")
            {
                $ret .= $this->dom->HDOM_DEFAULT_SPAN_TEXT;
            }
...
class simple_html_dom
{
    ...
    protected $HDOM_DEFAULT_BR_TEXT = "";
    public $HDOM_DEFAULT_SPAN_TEXT = "";
    ...
    function __construct($str=null, $lowercase=true, $forceTagsClosed=true, $target_charset=HDOM_DEFAULT_TARGET_CHARSET, $stripRN=true, $defaultBRText=HDOM_DEFAULT_BR_TEXT, $defaultSpanText=HDOM_DEFAULT_SPAN_TEXT)
    {
        if ($str)
        {
    ...
    function load($str, $lowercase=true, $stripRN=true, $defaultBRText=HDOM_DEFAULT_BR_TEXT, $defaultSpanText=HDOM_DEFAULT_SPAN_TEXT)
    {
        global $debugObject;
    ...
    protected function prepare($str, $lowercase=true, $stripRN=true, $defaultBRText=HDOM_DEFAULT_BR_TEXT, $defaultSpanText=HDOM_DEFAULT_SPAN_TEXT)
    {
        $this->clear();
        ...
        $this->HDOM_DEFAULT_BR_TEXT = $defaultBRText;
        $this->HDOM_DEFAULT_SPAN_TEXT = $defaultSpanText;
    ...
    protected function read_tag()
    {
        ...
        if ($node->tag == "br")
        {
            $node->_[HDOM_INFO_INNER] = $this->HDOM_DEFAULT_BR_TEXT;
        }
