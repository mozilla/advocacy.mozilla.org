      ...
      <div className={className}>
        <div className="page">
          ...
          <section>
            ...
            <p>Last week Federal Communications Commission Chairman Ajit Pai revealed the anti-net-neutrality proposal his agency is set to vote on Deceber 14th. <b>These rules are way, way, WAY worse than expected</b>.</p>
