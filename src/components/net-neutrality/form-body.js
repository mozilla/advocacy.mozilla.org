      ...
      <div className="form-body-container">
        <div className="form-body">
          ...
          <ul>
            ...
            <li><b>Net neutrality is fundamental to a user choice.</b> Without net neutrality, ISPs could decide you watched too many cat videos in one day and throttle your Internet speeds leaving you behind on the latest Maru memes.</li>
          </ul>
        </div>
      </div>
    );
