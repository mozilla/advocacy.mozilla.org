  ...
  render: function() {
    ...
    return (
      <div className="fcc-form-input-container">
        ...
        <label>
          Note: Mozilla will be filing this document on your behalf via <a href="https://www.fcc.gov/ecfs/filings/express">https://www.fcc.gov/ecfs/filings/express</a> into an official FCC proceeding. Per FCC guidelines, the FCC will make all information submitted, including names and addresses, publicly available via the web. Mozilla will otherwise manage your submitted information as explained in our privacy notice.
        </label>
